  ...
  head: () => ({
    meta: [
      ...
      { title: "Texcortech AI Social Command Centre" },
      {
        name: "description",
        content:
          "Secure social media operations for Texcortech Systems: compose, approve, schedule, publish and audit.",
      },
      { name: "author", content: "Texcortech Systems" },
      { property: "og:title", content: "Texcortech AI Social Command Centre" },
      {
        property: "og:description",
        content: "Governed social publishing with approvals, scheduling and a full audit trail.",
      },
